...
import com.symboltables.SeparateChainingSymbolTableImpl;
import com.symboltables.SymbolTable;

import junit.framework.TestCase;

public class TestSeparateChainingSymbolTableImpl extends TestCase{

    public void testEmpty() {
        // test empty SymbolTable
        SymbolTable<Integer, String> st = new SeparateChainingSymbolTableImpl<Integer, String>();
    ...
    public void testListOperations() {
        ...
        st = new SeparateChainingSymbolTableImpl<Integer, String>();
        st.put(20, "life");
        st.put(3, "good");
        st.put(4, "best");
        st.put(6, "java");
