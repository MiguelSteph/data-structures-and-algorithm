...
import com.graphs.ShortestPathWithBidirectionalDijkstra;

import junit.framework.TestCase;

public class TestShortestPathWithBidirectionalDijkstra extends TestCase{
    
    public void testShortestPathWithBidirectionalDijkstra() {
        ...
        ShortestPathWithBidirectionalDijkstra sp = new ShortestPathWithBidirectionalDijkstra(graph, 6, 3);
        assertEquals(23, sp.getShortestDistance());
        ...
        assertEquals(true, pathTo3.equals(sp.getShortestPath()));
