...
import com.graphs.ShortestPathWithBellmanFord;

import junit.framework.TestCase;

public class TestShortestPathWithBellmanFord extends TestCase {
    
    public void testShortestPathWithBellmanFord() {
        ...
        ShortestPathWithBellmanFord sp = new ShortestPathWithBellmanFord(graph, 6);
